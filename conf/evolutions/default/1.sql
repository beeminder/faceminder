...
create table "Service" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"provider" VARCHAR(254) NOT NULL,"owner" INTEGER NOT NULL,"username" VARCHAR(254) NOT NULL,"token" VARCHAR(254) NOT NULL,"expiry" BIGINT);
