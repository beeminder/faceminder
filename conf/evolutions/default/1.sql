...
create table "Goal" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"module" VARCHAR(254) NOT NULL,"owner" INTEGER NOT NULL,"slug" VARCHAR(254) NOT NULL,"title" VARCHAR(254) NOT NULL,"lastUpdated" BIGINT NOT NULL);
